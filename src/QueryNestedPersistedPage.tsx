...
function RollRow({ rollId }: { rollId: number }) {
  const { data, loading } = useQuery<{ user: { diceRoll: { value: number } } }>(USER_DICE_ROLL_QUERY, {
...
export default function QueryNestedPersistedPage() {
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.heading}>Dice Roller (Nested Query - Persisted)</h1>
